...
in case the original archive becomes unavailable or unstable. 

If you use these datasets, please cite the original source:

> Keogh, E., Taposh, D. R., Naik, U., Agrawal, A. (2021).
> *Multi-dataset time-series anomaly detection competition.* In: ACM SIGKDD
> International Conference on Knowledge Discovery and Data Mining (Vol. 29).

<details>
<summary>BibTeX</summary>

```bibtex
@inproceedings{keogh2021multi,
  title     = {Multi-dataset time-series anomaly detection competition},
  author    = {Keogh, E. and Taposh, D. R. and Naik, U. and Agrawal, A.},
...
```bibtex
@article{abanda2026granularity,
  title   = {Granularity misalignments in time series anomaly detection},
  author  = {Abanda, Amaia and Oregi, Izaskun and Del Ser, Javier},
  journal = {},
  year    = {2026}
}
```
